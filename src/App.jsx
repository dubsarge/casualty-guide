...
const OD = {
  ...
  gsw_lodged:{sym:{1:["Small caliber, lodged shallow"],2:["Significant bleeding, numbness spreading"],3:["Bullet deep, internal damage likely, cold sweats"],4:["Possible fragmentation, fading in and out"]},
    ...
    doEx:{1:["/do Small entry wound on their {z}. No exit. Bleeding controlled."],2:["/do Entry wound on {z}, no exit. Swelling fast. Numbness spreading below."],3:["/do Bullet wound on {z}. Blood pooling. Ashen. Pulse thready and rapid."]},
    wDoEx:{handgun:{1:["/do Small round entry on their {z}, about pencil-sized. Bleeding steady but controlled. Bullet somewhere inside."],2:["/do Revolver round lodged in {z}. Entry wound neat and round. Swelling fast around it. Numbness creeping outward."],3:["/do Pistol round buried deep in {z}. Blood pooling underneath. Skin going grey. Pulse weak and racing."]},sawnoff:{2:["/do Sawed-off blast tore into their {z} at close range. Dozens of pellets embedded in shredded flesh. Bleeding from everywhere."],3:["/do Point-blank sawed-off hit to {z}. One massive ragged crater of torn muscle and embedded shot. Barely conscious."]},repeater:{1:["/do Clean entry on {z} from a repeater round. Deeper channel than a pistol would leave. Bleeding moderate."],2:["/do Repeater round lodged in {z}. Entry wound slightly larger than a handgun's. Tissue damaged deeper along the path."],3:["/do Repeater round buried in {z}. Higher velocity means more damage than it looks. Blood flowing freely. Going pale."]},shotgun:{2:["/do Shotgun blast cratered their {z}. Dozens of pellet wounds clustered tight. Tissue pulped. Bleeding from every hole."],3:["/do Full shotgun hit to {z}. Pellet mass went in as one devastating blow. Wound cavity the size of a fist. Bone fragments visible. Fading fast."]},rifle:{2:["/do Large-caliber rifle round lodged in {z}. Entry wound notably bigger than a pistol's. Surrounding tissue bruised from energy transfer alone."],3:["/do High-caliber round buried in {z}. Entry wound is the size of a thumb. The energy shockwave has damaged tissue well beyond the bullet path. Ashen, barely responsive."]}},
  ...
  gsw_tt:{sym:{1:["Clean pass, entry small, exit bigger"],2:["Entry clean, exit messy, internal damage along path"],3:["Massive exit wound, shock"],4:["Exit devastating, barely responsive"]},
    ...
    doEx:{1:["/do Small entry on front of {z}, larger exit wound back. Bleeding both sides."],2:["/do Entry clean. Exit torn open on {z}. Bright and dark blood mixing."],3:["/do Through-and-through on {z}. Exit devastating. Ashen, pulse barely there."]},
    wDoEx:{handgun:{1:["/do Neat round entry on their {z}. Exit wound on the other side slightly larger, ragged. Bleeding from both."],2:["/do Revolver round punched clean through {z}. Entry pencil-sized. Exit torn open and weeping dark blood."],3:["/do Pistol round through {z}. Exit blown out, flesh peeled back. Blood mixing bright and dark. Going limp."]},sawnoff:{2:["/do Sawed-off blast ripped through {z}. Entry is a mess of pellet holes. Exit side is shredded — pellets tore through everything."],3:["/do Close-range sawed-off tore clean through {z}. Exit wound the size of two fists. Tissue, bone, blood everywhere."]},repeater:{1:["/do Repeater round passed through {z}. Entry clean, exit a bit ragged. Bleeding both sides but controlled."],2:["/do Repeater through {z}. Entry neat, exit torn wider. Deeper channel than a pistol — more damage along the path."]},shotgun:{2:["/do Shotgun pellets ripped through {z}. Entry a cluster of holes. Exit side is devastated — pellets scattered through tissue on the way out."],3:["/do Full shotgun blast clean through {z}. Entry is a cratered mass. Exit is catastrophic — tissue blown outward. Organs visible."]},rifle:{2:["/do High-caliber round punched through {z}. Entry notably large. Exit wound is blown wide open — fist-sized hole of torn flesh."],3:["/do Rifle round through {z}. The energy blew the exit wound open like a flower. Tissue destroyed for inches around the path. Barely alive."]}},
  ...
  stab_wound:{sym:{1:["Shallow puncture, sharp pain"],2:["Deep puncture, steady bleeding"],3:["Deep stab, internal damage, heavy bleeding"]},
    ...
    doEx:{1:["/do Puncture wound on {z}, couple inches deep."],2:["/do Deep stab in {z}. Blood wells up."],3:["/do Deep stab in {z}. Blood dark, flowing. Abdomen rigid. Skin cold."]},
    wDoEx:{knife:{1:["/do Clean narrow slit on their {z}. Blood welling up from the cut. Edges neat — a sharp blade."],2:["/do Knife buried deep in {z}. Blood seeping around the handle. The blade went in smooth and far."],3:["/do Blade driven to the hilt in {z}. Dark blood flowing around it. Skin going cold. The knife is plugging its own wound."]},bow:{1:["/do Arrow shaft protruding from {z}. Blood seeping around where it entered. Shaft wobbles with each breath."],2:["/do Arrow embedded deep in {z}. Broadhead cut a slit going in. Blood flows around the shaft. Moving the arrow shifts something inside."],3:["/do Arrow punched clean into {z}. Shaft buried to the fletching. Blood pooling. Every movement drives the broadhead deeper."]}},
