...
const Z = [
  ...
  {id:"heart_area",label:"Patient's Left Upper Chest",x:179,y:118,r:14,anat:["Left lung (upper)","Collarbone blood vessels","Ribs 2-4"],sev:3,desc:"Left lung fills this space. Puncture causes lung collapse.",reg:"chest",g:"Chest"},
  ...
  {id:"ur_chest",label:"Patient's Right Upper Chest",x:111,y:118,r:14,anat:["Heart","Aorta","Right lung (upper)","Ribs 2-4"],sev:4,desc:"The heart and aorta sit on this side. Damage to either is almost always fatal without immediate expert intervention.",reg:"chest",g:"Chest"},
  {id:"lm_chest",label:"Patient's Left Mid Chest",x:188,y:158,r:12,anat:["Left lung (lower)","Ribs 5-8","Liver edge"],sev:2,desc:"Lower right lung. Diaphragm begins here — damage affects breathing.",reg:"chest",g:"Chest"},
  {id:"rm_chest",label:"Patient's Right Mid Chest",x:102,y:158,r:12,anat:["Right lung (lower)","Ribs 5-8","Diaphragm (breathing muscle) edge"],sev:2,desc:"Lower left lung. Diaphragm begins here — damage affects breathing.",reg:"chest",g:"Chest"},
  {id:"ll_ribs",label:"Patient's Left Lower Ribs",x:193,y:194,r:11,anat:["Floating ribs 9-12","Liver (behind)","Diaphragm (breathing muscle)"],sev:2,desc:"Liver behind the right lower ribs. Largest internal organ, bleeds profusely when damaged.",reg:"chest",g:"Chest"},
  {id:"rl_ribs",label:"Patient's Right Lower Ribs",x:98,y:194,r:11,anat:["Floating ribs 9-12","Spleen (behind)","Diaphragm (breathing muscle)"],sev:2,desc:"Floating ribs offer less protection. Spleen sits behind — blood-rich, ruptures easily.",reg:"chest",g:"Chest"},
  {id:"ul_abd",label:"Patient's Left Upper Abdomen",x:172,y:212,r:14,anat:["Liver","Gallbladder","Left kidney (deep)","First section of small intestine"],sev:3,desc:"Dominated by the liver — massive and blood-filled. Heavy bleeding is the danger.",reg:"abdomen",g:"Abdomen"},
  {id:"ur_abd",label:"Patient's Right Upper Abdomen",x:118,y:212,r:14,anat:["Spleen","Stomach","Pancreas (tail)","Right kidney (deep)"],sev:3,desc:"Spleen is fragile and blood-rich. Stomach sits centrally. Kidney tucked deep.",reg:"abdomen",g:"Abdomen"},
  ...
  {id:"ll_abd",label:"Patient's Left Lower Abdomen",x:166,y:267,r:11,anat:["Appendix","Large intestine (right side)","Left hip blood vessels"],sev:1,desc:"Appendix sits here. Intestinal damage is the main concern.",reg:"abdomen",g:"Abdomen"},
  {id:"lr_abd",label:"Patient's Right Lower Abdomen",x:124,y:267,r:11,anat:["Large intestine (left side)","Bladder (lower)","Right hip blood vessels"],sev:1,desc:"Mostly large intestine. Contents leaking into the body cavity cause deadly infection.",reg:"abdomen",g:"Abdomen"},
