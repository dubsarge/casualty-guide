...
// ═══════════════════════════════════════════════════════════════════════════════
const Z = [
  {id:"crown",label:"Top of Head",x:150,y:14,r:14,anat:["Parietal bone (top of skull)","Brain (parietal lobe)"],sev:2,desc:"Thick bone but blunt force causes concussions. Scalp bleeds heavily — very vascular.",reg:"head",g:"Head"},
  {id:"forehead",label:"Forehead",x:150,y:28,r:10,anat:["Frontal bone (forehead plate) (thick)","Brain (frontal lobe)"],sev:2,desc:"Relatively thick bone offering decent protection, but hard hits fracture it or concuss the brain beneath.",reg:"head",g:"Head"},
  {id:"l_temple",label:"Left Temple",x:130,y:22,r:8,anat:["Temporal bone (side of skull) (thin)","Temporal artery","Brain (temporal lobe)"],sev:3,desc:"One of the thinnest skull areas. The temporal artery is just beneath. Trauma here is extremely dangerous.",reg:"head",g:"Head"},
  {id:"r_temple",label:"Right Temple",x:169,y:22,r:8,anat:["Temporal bone (side of skull) (thin)","Temporal artery","Brain (temporal lobe)"],sev:3,desc:"Thinnest skull area. Temporal artery beneath. Extremely dangerous to trauma.",reg:"head",g:"Head"},
  {id:"l_eye",label:"Left Eye",x:139,y:30,r:6,anat:["Eyeball","Optic nerve (carries vision to brain)","Orbital bone (eye socket ring)"],sev:2,desc:"The eye socket provides some bony protection, but the eye itself is extremely fragile. Damage can cause partial or total blindness.",reg:"head",g:"Head"},
  {id:"r_eye",label:"Right Eye",x:160,y:30,r:6,anat:["Eyeball","Optic nerve (carries vision to brain)","Orbital bone (eye socket ring)"],sev:2,desc:"The orbital bone shields the eye but direct trauma risks blindness. Even minor injuries can impair vision — swelling, blood in the eye, or scratched cornea.",reg:"head",g:"Head"},
  {id:"l_ear",label:"Left Ear",x:125,y:30,r:7,anat:["Ear canal","Eardrum","Inner ear (balance)"],sev:1,desc:"Outer ear tears easily and bleeds heavily. Eardrum damage from blasts or blows causes deafness or vertigo. Fluid from the ear after head trauma suggests skull fracture.",reg:"head",g:"Head"},
  {id:"r_ear",label:"Right Ear",x:174,y:30,r:7,anat:["Ear canal","Eardrum","Inner ear (balance)"],sev:1,desc:"Outer ear bleeds heavily when torn. Eardrum damage causes hearing loss and balance issues. Fluid leaking from the ear after a blow is a red flag for skull fracture.",reg:"head",g:"Head"},
  {id:"nose",label:"Nose",x:150,y:42,r:7,anat:["Nasal bone (thin)","Nose cartilage (flexible part)","Sinuses","Blood vessels (rich supply)"],sev:1,desc:"The nasal bone breaks easily — one of the most common facial fractures. Bleeds heavily due to rich blood supply.",reg:"head",g:"Head"},
  {id:"mouth",label:"Mouth / Jaw",x:150,y:53,r:7,anat:["Jawbone","Teeth","Tongue","Oral blood vessels"],sev:1,desc:"The jaw can fracture or dislocate. Teeth can be knocked out or shattered. The tongue bleeds profusely if bitten through.",reg:"head",g:"Head"},
  {id:"chin",label:"Chin",x:150,y:64,r:6,anat:["Mandible (jawbone tip)","Chin muscle"],sev:1,desc:"A hard hit to the chin transmits force into the jaw joint and skull, causing a knockout or concussion even without visible damage.",reg:"head",g:"Head"},
  {id:"l_neck",label:"Left Neck",x:142,y:80,r:7,anat:["Left carotid artery","Left jugular vein","Neck vertebrae (spine)"],sev:4,desc:"Carotid carries blood to the brain — severing it means death in minutes. Jugular returns blood from the head.",reg:"neck",g:"Neck"},
  {id:"r_neck",label:"Right Neck",x:157,y:80,r:7,anat:["Right carotid artery","Right jugular vein","Neck vertebrae (spine)"],sev:4,desc:"Carotid and jugular critically exposed. Spinal damage at this level can mean paralysis or death.",reg:"neck",g:"Neck"},
  {id:"throat",label:"Throat",x:150,y:85,r:6,anat:["Windpipe","Food pipe","Thyroid"],sev:3,desc:"Windpipe sits right at the surface with almost no protection. Damage compromises breathing immediately.",reg:"neck",g:"Neck"},
  {id:"heart_area",label:"Upper Left Chest",x:117,y:110,r:14,anat:["Heart","Aorta","Left lung (upper)","Ribs 2-4"],sev:4,desc:"The heart and aorta. Damage to either is almost always fatal without immediate expert intervention.",reg:"chest",g:"Chest"},
  {id:"sternum",label:"Breastbone",x:150,y:115,r:10,anat:["Breastbone","Heart (behind)","Major vessels"],sev:3,desc:"Flat bone shielding the heart. Can fracture from blunt force; a bullet punches through into the heart.",reg:"chest",g:"Chest"},
  {id:"ur_chest",label:"Upper Right Chest",x:182,y:110,r:14,anat:["Right lung (upper)","Collarbone blood vessels","Ribs 2-4"],sev:3,desc:"Right lung fills this space. Puncture causes lung collapse.",reg:"chest",g:"Chest"},
  {id:"lm_chest",label:"Left Mid Chest",x:100,y:142,r:12,anat:["Left lung (lower)","Ribs 5-8","Diaphragm (breathing muscle) edge"],sev:2,desc:"Lower left lung. Diaphragm begins here — damage affects breathing and organs below.",reg:"chest",g:"Chest"},
  {id:"rm_chest",label:"Right Mid Chest",x:198,y:142,r:12,anat:["Right lung (lower)","Ribs 5-8","Liver edge"],sev:2,desc:"Lower right lung. Liver peeks up under the ribs.",reg:"chest",g:"Chest"},
  {id:"ll_ribs",label:"Left Lower Ribs",x:95,y:169,r:11,anat:["Floating ribs 9-12","Spleen (behind)","Diaphragm (breathing muscle)"],sev:2,desc:"Floating ribs offer less protection. Spleen sits behind — blood-rich, ruptures easily.",reg:"chest",g:"Chest"},
  {id:"rl_ribs",label:"Right Lower Ribs",x:204,y:169,r:11,anat:["Floating ribs 9-12","Liver (behind)","Diaphragm (breathing muscle)"],sev:2,desc:"Liver behind the right lower ribs. Largest internal organ, bleeds profusely when damaged.",reg:"chest",g:"Chest"},
  {id:"ul_abd",label:"Upper Left Abdomen",x:117,y:191,r:12,anat:["Spleen","Stomach","Pancreas (tail)","Left kidney (deep)"],sev:3,desc:"Spleen is fragile and blood-rich. Stomach sits centrally. Kidney tucked deep.",reg:"abdomen",g:"Abdomen"},
  {id:"ur_abd",label:"Upper Right Abdomen",x:182,y:191,r:12,anat:["Liver","Gallbladder","Right kidney (deep)","First section of small intestine"],sev:3,desc:"Dominated by the liver — massive and blood-filled. Heavy bleeding is the danger.",reg:"abdomen",g:"Abdomen"},
  {id:"c_abd",label:"Center Abdomen",x:150,y:218,r:12,anat:["Small intestine","Main artery from the heart (deep)","Main vein to the heart"],sev:2,desc:"Intestines up front. Deep behind them, the aorta and vena cava. Intestinal injuries risk deadly infection.",reg:"abdomen",g:"Abdomen"},
  {id:"ll_abd",label:"Lower Left Abdomen",x:128,y:245,r:11,anat:["Large intestine (left side)","Bladder (lower)","Left hip blood vessels"],sev:1,desc:"Mostly large intestine. Contents leaking into the body cavity cause deadly infection.",reg:"abdomen",g:"Abdomen"},
  {id:"lr_abd",label:"Lower Right Abdomen",x:171,y:245,r:11,anat:["Appendix","Large intestine (right side)","Right hip blood vessels"],sev:1,desc:"Appendix sits here. Intestinal damage is the main concern.",reg:"abdomen",g:"Abdomen"},
  {id:"groin",label:"Groin / Pelvis",x:150,y:270,r:10,anat:["Thigh artery (femoral) origin","Pelvic bones","Bladder","Nerves"],sev:3,desc:"Femoral arteries branch off here. Pelvis protects bladder. Pelvic fractures bleed internally.",reg:"abdomen",g:"Abdomen"},
  {id:"l_shoulder",label:"Left Shoulder",x:81,y:95,r:11,anat:["Shoulder joint","Collarbone","Shoulder muscle","Shoulder tendons"],sev:1,desc:"Ball-and-socket joint, prone to dislocation. Collarbone fractures easily.",reg:"leftArm",g:"Left Arm"},
  {id:"r_shoulder",label:"Right Shoulder",x:218,y:95,r:11,anat:["Shoulder joint","Collarbone","Shoulder muscle","Shoulder tendons"],sev:1,desc:"Ball-and-socket joint. Collarbone fractures easily.",reg:"rightArm",g:"Right Arm"},
  {id:"l_uarm",label:"Left Upper Arm",x:68,y:126,r:12,anat:["Upper arm bone","Inner arm artery","Upper arm muscles"],sev:1,desc:"Inner arm artery runs along the inside. Arterial damage here can be serious.",reg:"leftArm",g:"Left Arm"},
  {id:"l_elbow",label:"Left Elbow",x:57,y:162,r:8,anat:["Elbow joint","Funny bone nerve","Inner arm artery"],sev:1,desc:"Hinge joint. Funny bone nerve at the surface. Dislocation possible.",reg:"leftArm",g:"Left Arm"},
  {id:"l_farm",label:"Left Forearm",x:48,y:196,r:11,anat:["Forearm bones (radius & ulna)","Wrist artery","Tendons"],sev:0,desc:"Two parallel bones. Wrist artery at the wrist side. Tendon damage affects hand function.",reg:"leftArm",g:"Left Arm"},
  {id:"l_hand",label:"Left Hand (Palm)",x:44,y:240,r:10,anat:["Hand bones","Palm tendons","Palm blood vessels"],sev:0,desc:"Complex bone and tendon structure. Injuries affect grip. Defensive wounds common here.",reg:"leftArm",g:"Left Arm"},
  {id:"l_fingers",label:"Left Fingers",x:40,y:268,r:10,anat:["Finger bones","Finger tendons","Small nerves","Nail bed"],sev:0,desc:"Tiny bones connected by tendons. Can be broken, dislocated, crushed, or amputated. Loss affects dexterity permanently.",reg:"leftArm",g:"Left Arm"},
  {id:"r_uarm",label:"Right Upper Arm",x:231,y:126,r:12,anat:["Upper arm bone","Inner arm artery","Upper arm muscles"],sev:1,desc:"Inner arm artery inside. Fractures painful but survivable.",reg:"rightArm",g:"Right Arm"},
  {id:"r_elbow",label:"Right Elbow",x:242,y:162,r:8,anat:["Elbow joint","Funny bone nerve","Inner arm artery"],sev:1,desc:"Hinge joint. Funny bone nerve exposed. Dislocation possible.",reg:"rightArm",g:"Right Arm"},
  {id:"r_farm",label:"Right Forearm",x:251,y:196,r:11,anat:["Forearm bones (radius & ulna)","Wrist artery","Tendons"],sev:0,desc:"Two bones. Wrist artery at wrist. Tendon cuts affect grip.",reg:"rightArm",g:"Right Arm"},
  {id:"r_hand",label:"Right Hand (Palm)",x:255,y:240,r:10,anat:["Hand bones","Palm tendons","Palm blood vessels"],sev:0,desc:"Defensive wound location. Tendon/bone damage affects grip permanently.",reg:"rightArm",g:"Right Arm"},
  {id:"r_fingers",label:"Right Fingers",x:258,y:268,r:10,anat:["Finger bones","Finger tendons","Small nerves","Nail bed"],sev:0,desc:"Small bones and tendons. Easily broken or dislocated. Loss of trigger finger is significant for gunslingers.",reg:"rightArm",g:"Right Arm"},
  {id:"l_uthigh",label:"Left Upper Thigh",x:120,y:305,r:12,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) — one of the largest. Damage means death in minutes.",reg:"leftLeg",g:"Left Leg"},
  {id:"l_mthigh",label:"Left Mid Thigh",x:117,y:340,r:11,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle around femur. GSWs can pass through without hitting bone.",reg:"leftLeg",g:"Left Leg"},
  {id:"l_knee",label:"Left Knee",x:116,y:371,r:9,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint with ligaments. Artery behind the knee. Knee injuries severely limit mobility.",reg:"leftLeg",g:"Left Leg"},
  {id:"l_shin",label:"Left Shin / Calf",x:113,y:420,r:12,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone right at the surface. Common fracture site.",reg:"leftLeg",g:"Left Leg"},
  {id:"l_ankle",label:"Left Ankle",x:112,y:460,r:8,anat:["Ankle joint","Achilles tendon (heel cord)","Side ligaments"],sev:0,desc:"Ankle sprains and fractures common. Achilles tendon is vulnerable.",reg:"leftLeg",g:"Left Leg"},
  {id:"l_foot",label:"Left Foot",x:108,y:480,r:9,anat:["Foot bones","Foot arch","Sole tissue"],sev:0,desc:"Many small bones. Crushing injuries painful and slow to heal.",reg:"leftLeg",g:"Left Leg"},
  {id:"l_toes",label:"Left Toes",x:105,y:496,r:8,anat:["Toe phalanges","Toe tendons","Small nerves"],sev:0,desc:"Tiny bones that break easily. Big toe is critical for balance.",reg:"leftLeg",g:"Left Leg"},
  {id:"r_uthigh",label:"Right Upper Thigh",x:179,y:305,r:12,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) here can mean death in minutes.",reg:"rightLeg",g:"Right Leg"},
  {id:"r_mthigh",label:"Right Mid Thigh",x:182,y:340,r:11,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle. Less dangerous than upper thigh.",reg:"rightLeg",g:"Right Leg"},
  {id:"r_knee",label:"Right Knee",x:182,y:371,r:9,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint. Artery behind the knee. Limits mobility severely.",reg:"rightLeg",g:"Right Leg"},
  {id:"r_shin",label:"Right Shin / Calf",x:185,y:420,r:12,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone close to surface. Fractures common.",reg:"rightLeg",g:"Right Leg"},
  {id:"r_ankle",label:"Right Ankle",x:185,y:460,r:8,anat:["Ankle joint","Achilles tendon (heel cord)","Side ligaments"],sev:0,desc:"Achilles tendon exposed at the back. Ankle fractures limit all mobility.",reg:"rightLeg",g:"Right Leg"},
  {id:"r_foot",label:"Right Foot",x:190,y:480,r:9,anat:["Foot bones","Foot arch","Sole tissue"],sev:0,desc:"Small bones, easily crushed. Walking impaired.",reg:"rightLeg",g:"Right Leg"},
  {id:"r_toes",label:"Right Toes",x:194,y:496,r:8,anat:["Toe phalanges","Toe tendons","Small nerves"],sev:0,desc:"Small fragile bones. Big toe loss affects balance and gait.",reg:"rightLeg",g:"Right Leg"},
  {id:"u_back",label:"Upper Back",x:150,y:126,r:16,anat:["Upper spine","Spinal cord","Shoulder blades","Lungs (behind ribs)"],sev:3,desc:"Spinal cord here — damage means paralysis. Shoulder blades offer some protection.",reg:"back",g:"Back",bo:true},
  {id:"m_back",label:"Mid Back",x:150,y:175,r:16,anat:["Upper and lower spine","Spinal cord","Kidneys (flanks)","Rear ribs"],sev:3,desc:"Kidneys on either side of the spine — blood-rich, vulnerable from behind.",reg:"back",g:"Back",bo:true},
  {id:"lo_back",label:"Lower Back",x:150,y:229,r:16,anat:["Lower spine","Spinal nerves","Major back muscles"],sev:2,desc:"Lower spine bears most body weight. Nerve damage here affects legs.",reg:"back",g:"Back",bo:true},
];
...
const SV = [
  ...
  {v:5,l:"Critical",c:"#4a0000",ic:"3+ days IC",ooc:"Up to 72 hours OOC (max)",d:"You were at death's door. Life-altering consequences possible. Recovery is a story arc, not a scene."},
];
      ...
      {has&&tab!=="journal"&&tab!=="quickref"&&(<div style={{background:"#fff9f0",border:"2px solid #c4a882",borderRadius:12,padding:"14px 11px",boxShadow:"0 2px 8px rgba(61,43,31,.06)"}}>
        ...
        {val.map((inj,i)=>{const zone=Z.find(z=>z.id===inj.zid);const data=OD[inj.type];if(!data||!zone)return null;
          ...
          return(<div key={i} style={{marginBottom:14,paddingBottom:14,borderBottom:"1px dashed #c4a882"}}>
            ...
            <Sec title="Recovery & Follow-Up" color="#cd6600"><div style={{display:"flex",gap:10,marginBottom:4,flexWrap:"wrap"}}><P style={{fontWeight:"bold",color:"#cd6600"}}>IC: {si.ic}</P><P style={{fontWeight:"bold",color:"#8b7355"}}>OOC: {si.ooc}</P></div><P>{si.d}</P>{data.rec&&data.rec.map((r,j)=><P key={j}>• {r}</P>)}<P style={{fontSize:10.5,fontStyle:"italic",color:"#a08968"}}>72h OOC is the max guideline — you can always extend if it fits your character's story. The doc has final say on clearance.</P></Sec>
